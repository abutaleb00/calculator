        ...
        >
          ...
          <div className="w-full bg-[#f9dcb8]">
            <div className="flex w-full">
              <div className="w-1/6 mx-[1px] my-[1px] ">
                <button className="w-full h-16 outline-none focus:outline-none bg-[#f7ccb2] hover:bg-opacity-80 text-black text-xl font-light">
                  MC
                </button>
              </div>
              <div className="w-1/6 mx-[1px] my-[1px]">
            ...
            <div className="flex w-full">
              <div className="w-1/4  mx-[1px] my-[1px]">
                <button className="w-full h-16 outline-none focus:outline-none bg-[#ffe5d5] hover:bg-opacity-80 text-black text-xl font-light">
                  C
                </button>
              </div>
              <div className="w-1/4  mx-[1px] my-[1px]">
              ...
              <div className="w-1/4  mx-[1px] my-[1px]">
                <button className="w-full h-16 outline-none focus:outline-none bg-[#ffe5d5] hover:bg-opacity-80 text-black text-2xl font-light">
                  x
                </button>
              </div>
            </div>
